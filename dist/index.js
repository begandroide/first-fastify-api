...
var app = fastify.default({
    logger: true
});
routes_1.default.forEach(function (route) {
    app.route(route);
});
mongoose_1.default.connect('mongodb://localhost/myFirstApi', { useNewUrlParser: true, useUnifiedTopology: true })
    .then(function () { return console.log('MongoDB connected...'); })
    .catch(function (err) { console.log(err); });
// Register Swagger
app.register(fastify_swagger_1.default, swagger_1.Options);
